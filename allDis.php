...
<body >
    ...
    <nav class="navbar navbar-expand-lg ">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="profileView\profileView.php">My Profile</a>
          </li>
          <li class="nav-item">
  ...
  if(empty($_SESSION['id']))
  {
    echo' <p align=right><strong>Can\'t check-out without login !!</strong></p>';
  }
  ?>
    ...
    <div class="wrap">
   <div class="search">
      <input type="text" name="searchText" class="searchTerm" required placeholder="What are you looking for? Specify category ">
      ...
      while($row=mysqli_fetch_array($data,MYSQLI_ASSOC)){
        ...
        if($c1==1)
        {
         ...
         { 
          ...
          echo '<button type ="button" class="open-button"'.($disable ? " disabled=\"disabled\"" : "").'onclick="Setc('.$row["price"].')">Check-Out</button>';
